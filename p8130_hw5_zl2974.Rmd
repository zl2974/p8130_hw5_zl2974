...
4. The CI for $X_h$ = 28 is $(`r gpa_ci %>% select(- fit) %>% pull(lwr)`,`r gpa_ci %>% select(- fit) %>% pull(upr)` )$

5. The PI for $X_h$ = 28 is $(`r gpa_pi %>% select(- fit) %>% pull(lwr)`,`r gpa_pi %>% select(- fit) %>% pull(upr)` )$
